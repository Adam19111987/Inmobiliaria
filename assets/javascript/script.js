const propiedades_venta = [
  ...
  // Llamar a las funciones de renderizado cuando el DOM esté cargado
  document.addEventListener("DOMContentLoaded", function () {
    renderizarPropiedades(propiedades_venta, "ventaContainer");
    renderizarPropiedades(propiedades_alquiler, "alquilerContainer");
  });
